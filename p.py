...
def ige():
    os.system("clear")
    input(yellow+"\n 🌸🌸🌸"+white+" Vào Web Tool? ")
    print(yellow+" 🌸🌸🌸"+white+" Đang Vào Web...")
    os.system("https://zalo.me/g/nguadz335")
    time.sleep(7)
    input("\n [BACK]")
    main()
...
#def about():
    ...
    print(yellow+'║'+cyan+'[ Author ]    '+purple+' :[DUY KHÁNH] ')
    print(cyan+'   ║[Youtube] '+purple+' :[ REVIEWTOOL247NDK ]')
    print(cyan+'   ║[Box Zalo]     '+purple+' :[ https://zalo.me/g/nguadz335 ]\n')
    print('\n[01] Main Menu')
    print('[02] Exit')
...
def encryptsh():
    ...
    with open(".temp",'r') as temp_f, open(out_file,'w') as out_f:
        ...
        out_f.write("# Copyright: REVIEWTOOL247\n# Tác Giả: DUY KHÁNH\n# YTB: REVIEWTOOL247NDK\n\n"+filedata)
    os.remove(".temp")
...
def main():
    ...
    print(yellow+'║'+green+' ['+white+'5'+green+']'+yellow+' Vào Box Share Tool')
